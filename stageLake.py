                                                        ...
                                                        while exploring3:
                                                            ...
                                                            if e3 == "down":
                                                                ...
                                                                while found:
                                                                    ...
                                                                    if f1 == "pineapple":
                                                                        functions.clearConsole()
                                                                        pineapple = climage.convert('images/pineapple.png', is_unicode=True, width= 130)
                                                                        print (pineapple)
                                                                        print("It looks like some kind of sponge is living inside...")
                                                                        functions.clearConsoleEnt()
                                                                    elif f1 == "crusty crab":
                                                                        functions.clearConsole()
                                                                        crab = climage.convert('images/crab.png', is_unicode=True, width= 130)
                                                                        print (crab)
                                                                        print("it somehow smells like burgers in here...")
                                                                        functions.clearConsoleEnt()
                                                                    elif f1 == "rock":
                                                                        functions.clearConsole()
                                                                        rock = climage.convert('images/rock.png', is_unicode=True, width= 130)
                                                                        print (rock)
...
""")
                                                                        ...
                                                                        output = climage.convert('images/noOne.jpg', is_unicode=True, width= 130)
                                                                        print(output)
                                                                        print("\t\t\t\tWHAT?")
